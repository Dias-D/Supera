  ...
  <div class="mt-16">
    <form @submit.prevent="handleSubmit">
      <label class="block">
        ...
        <input v-model="state.name.value" type="text" placeholder="Jane Doe"
      ...
      <label class="block mt-9">
        ...
        <input v-model="state.email.value" type="email" placeholder="jane.doe@gmail.com"
      ...
      <button :disable="state.isLoading" type="submit" :class="{ 'opacity-50': state.isLoading }"
