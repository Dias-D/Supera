<template>
  <div class="flex justify-between">
    <h1 class="text-4xl font-black text-gray-800">Registrar-se</h1>
  ...
  <div class="mt-16">
    <form @submit.prevent="handleSubmit">
      ...
      <button
        ...
        class="px-8 py-3 mt-10 text-2xl font-bold text-white rounded-full bg-black focus:outline-none transition-all duration-150"
      >
