    ...
    <div class="header-group">
      <div class="flex items-center justify-between py-10">
        ...
        <div class="flex">
          ...
          <button
            @click="() => emit('login')"
            class="px-6 py-2 font-bold bg-white rounded-full text-brand-main focus:outline"
          >
            Entrar
          </button>
        </div>
      ...
      <div class="flex flex-col mt-28">
        ...
        <div>
          <button
            class="px-6 py-2 mt-10 font-bold bg-white rounded-full text-brand-main focus:outline"
          >
